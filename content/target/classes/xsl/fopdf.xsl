				...
				<fo:table-body>
						...
						<fo:table-cell text-align="center">
							<fo:block>
								<fo:external-graphic content-width="scale-to-fit" content-height="scale-to-fit" width="100mm"
									src="../images/discursive-logo.png" />
							</fo:block>
					...
					<fo:table-row>
						<fo:table-cell text-align="center">
							...
							<fo:block font-family="Helvetica" font-size="12pt"
								padding="10mm">
								<xsl:text>Copyright &#xA9; 2009</xsl:text>
							</fo:block>
    ...
    <xsl:template name="footer.content">
		...
		<xsl:variable name="Version">
			<xsl:if test="//releaseinfo">
				<xsl:text>Common Java Cookbook (</xsl:text><xsl:value-of select="//releaseinfo" /><xsl:text>)</xsl:text>
			</xsl:if>
		</xsl:variable>
        <xsl:choose>
