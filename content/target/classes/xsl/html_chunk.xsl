...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="user.header.navigation">
      ...
      <div id="user-header">
        <div id="logo">
            <a href="http://www.discursive.com" title="${project.organization.slogan}">
                <img src="../images/discursive-logo.png" border="0"/>
            </a>
        </div>
        <div id="right-header">
                                ...
                                <td width="20%" align="center">
                                    <span style="color:white;font-size:90%;">
                                        <a href="http://www.sonatype.com/"
                                           title="Discursive: Discursive">Sponsored by Discursive
                                        </a>
                                    </span>
                                </td>
